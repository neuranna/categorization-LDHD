...
# load data
dat.langloc.lang <- read.csv('../data/Expt3_neuro_data/LHlang_langlocSN_langlocSN.csv')
dat.langloc.cat <- read.csv('../data/Expt3_neuro_data/LHlang_langlocSN_Categorization.csv')
dat.MDloc.MD <- read.csv('../data/Expt3_neuro_data/MD_spatialWM_spatialWM.csv')
dat.MDloc.cat <- read.csv('../data/Expt3_neuro_data/MD_spatialWM_Categorization.csv')
dat.MDloc.lang <- read.csv('../data/Expt3_neuro_data/MD_spatialWM_langlocSN.csv')
dat.cat.cat <- read.csv('../data/Expt3_neuro_data/Catparcels_categorization_categorization.csv')
dat.cat.lang <- read.csv('../data/Expt3_neuro_data/Catparcels_categorization_langlocSN.csv')
dat.cat.MD <- read.csv('../data/Expt3_neuro_data/Catparcels_categorization_spatialFIN.csv')
...
ggsave("Plots/lang_plot.eps", height=8, width=24, units="cm")
```
...
ggsave("Plots/MD_plot_LH.eps", height=8, width=24, units="cm")
...
ggsave("Plots/MD_plot_RH.eps", height=8, width=24, units="cm")
```
